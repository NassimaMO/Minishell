...
COMMON_SRCS					=	history.c redirect.c redirect_utils.c exit.c ft_split_set.c echo.c quotes.c path.c env.c init.c print.c signals.c split.c \
								commands.c pipex.c input.c manage_input.c pipex_utils.c env_utils.c
